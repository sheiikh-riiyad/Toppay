...
export default function MobileRechargeSubmittedScreen() {
    ...
    <SafeAreaView style={styles.screen} edges={['top']}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.successIcon}>
          <MaterialIcons name="check-circle" size={80} color={palette.cyan} />
        </View>

        <View style={styles.successCard}>
          <Text style={styles.successTitle}>{t('mobileRechargePage.submittedTitle')}</Text>
          <Text style={styles.successMeta}>{t('generic.pendingReview')}</Text>
        </View>

        <View style={styles.amountCard}>
          <Text style={styles.amountLabel}>{t('mobileRechargePage.rechargeAmount')}</Text>
        ...
        <View style={styles.detailsCard}>
          ...
          <DetailDivider />
          <DetailRow label={t('mobileRechargePage.provider')} value={provider} />
          {requestId ? (
            <>
              <DetailDivider />
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>{t('mobileRechargePage.submittedMeta')}</Text>
        </View>
